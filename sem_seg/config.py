...
class S3DISConfig:
    ...
    kernel_size = 15 # np.random.choice([3, 5, 9, 15])
    num_feats = 4  # np.random.choice([4, 9])  # np.random.choice([4, 5, 9])
    lr = 0.0001 # np.random.choice([1e-3, 1e-4])
    batch_size = 8 # int(np.random.choice([8, 16, 32]))
    sigma = 0.1 # np.random.choice([0.02, 0.05, 0.1, 0.5, 1.5, 2.5])
